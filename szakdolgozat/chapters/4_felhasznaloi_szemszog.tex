...
Az alkalmazáshoz készített chat felületről látható egy kép \aref{fig:chat} ábrán.
...
A játék táblájáról egy áttekintést láthatunk \aref{fig:zoopoly_table}. ábrán.
...
Az Online Játékosok ablakban megjelennek a játékosok adatai (\ref{fig:stats}. ábra).
\begin{enumerate}
