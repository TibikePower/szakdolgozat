/**
 * Table model representing the game board
 */
...
export default class Table {
  ...
  updateFromServer(data) {
    if (data) {
      if (data._playerPosition) {
        this._playerPosition = data._playerPosition;
      }
      if (data._activeField) {
        this._activeField = data._activeField;
      }
    }
  }
}
